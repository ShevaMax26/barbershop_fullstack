                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center justify-content-between">
                                <a href="{{ route('rank.create') }}" class="btn btn-primary">Створити</a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="{{ route('rank.show', $rank->id) }}"><i class="far fa-eye mr-3"></i></a>
                                                <a href="{{ route('rank.edit', $rank->id) }}"><i class="fas fa-pen text-warning mr-3"></i></a>

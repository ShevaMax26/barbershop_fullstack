                    ...
                    <ul class="footer-list">
                        ...
                        <li>
                            <div class="blog-card">
                                ...
                                <figure class="card-banner img-holder" style="--width: 70; --height: 75;">
                                    <img src="/assets/images/footer-blog-1.jpg" width="70" height="75"
                                         loading="lazy"
                        ...
                        <li>
                            <div class="blog-card">
                                ...
                                <figure class="card-banner img-holder" style="--width: 70; --height: 75;">
                                    <img src="/assets/images/footer-blog-2.jpg" width="70" height="75"
                                         loading="lazy"
                                ...
                                <div class="card-content">
                                    <h3>
                                        <a href="#" class="card-title">How do I get rid of unwanted hair on my
                                            face?</a>
                                    </h3>
